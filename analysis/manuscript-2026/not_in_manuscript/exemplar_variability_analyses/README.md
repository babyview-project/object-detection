...
> **CCN 2026 poster:** The current Plots A–C pipeline, scripts, and outputs live in
> [`../../../ccn-2026/README.md`](../../../ccn-2026/README.md). Use that folder for new
> runs; this subfolder is the earlier exploratory workflow that informed it.

Part of `analysis/manuscript-2026/not_in_manuscript/` (not in the June 2026
submission; main pipeline is `../../01`–`10`). This subfolder contains Jupyter notebooks (and equivalent Python scripts)
for analyzing within-category exemplar variability in BabyView (BV) and THINGS embeddings
(CLIP and DINOv3). The notebooks are numbered in a suggested run order; dependencies between them are described below.
