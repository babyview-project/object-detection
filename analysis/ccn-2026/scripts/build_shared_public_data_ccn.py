...
def build() -> None:
    ...
    if SHARED_DIR.exists():
        for sub in ("embeddings", "montages", "crops", "public"):
            src = SHARED_DIR / sub
    ...
    # Optional: embedding + crop + montage + public zips (built separately).
    for rel in (
        ...
        "crops/valid7018_crops.zip",
        "crops/valid7018_crops_zip.json",
        "montages/valid7018_montage_crops.zip",
        "montages/valid7018_montage_crops_zip.json",
        "public/README.md",
        "public/valid7018_public_release.json",
        "public/crops/valid7018_public_crops.zip",
        "public/embeddings/valid7018_public_embeddings.zip",
        "public/embeddings/valid7018_embedding_norm_stats.json",
    ):
    ...
    manifest = {
        ...
        "description": (
            "CCN 2026 shared intermediate data for the valid7018 cohort "
            "(7,018 rater-validated crops): category-level metrics plus "
            "paired per-crop embeddings and JPEG crops."
        ),
        "notes": [
            "Crop and embedding zips use category/stem filenames aligned 1:1.",
            "Montage zip remains a Figure-1A thumbnail subset only.",
