...
| File | Content |
|------|---------|
| `fig1A_valid7018_montages_low_to_high_global.*` | Montages: clock → plant → blanket → pajamas → book |
...
| `fig_explore_frequency_vs_global_robustness_2x2.*` | Frequency vs dispersion robustness |
