...
#python predict_text_prompt.py     --source bus.jpg     --checkpoint pretrain/yoloe-v8l-seg.pt     --names bus cat person     --device cuda:0
...
def main():
    ...
    if not args.output:
        ...
        base = os.getcwd()
        args.output = f"{base}-hands-face-output{ext}"
